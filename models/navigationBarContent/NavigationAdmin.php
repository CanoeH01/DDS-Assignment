 ...
 * page navigation bar for a logged in Administrator user.  
 * 
...
class NavigationAdmin implements NavigationInterface {
        ...
        /**
         *
         * @var String $modelType Identifies this navigation model type  
         */
        protected $modelType; 
        ...
        public function setmenuNav(){//set the menu items depending on the users selected page ID
            ...
            if($this->loggedin){ 
                ...
                switch ($this->pageID) {
                    ...
                    case "logout":
                        $this->menuNav.='<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Users <span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="'.$_SERVER['PHP_SELF'].'?pageID=manageUsers">Manage Users</a></li>
                                                <li><a href="'.$_SERVER['PHP_SELF'].'?pageID=myProfile">My Profile</a></li>
                                            </ul>
                                        </li>';
