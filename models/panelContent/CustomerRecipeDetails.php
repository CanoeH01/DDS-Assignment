...
/**
 * CustomerRecipeDetails is an extended PanelModel Class
 * 
...
class CustomerRecipeDetails extends PanelModel {
    ...
    */  
    function __construct($user,$db,$postArray,$pageTitle,$pageHead,$pageID){  
        $this->modelType='CustomerRecipeDetails';
            ...
            case "recipeDetails":
                ...
                if (isset($this->postArray['btnDeleteRecipe'])) {
                    ...
                    if ($userID === $recipe['creatorID']) {
                        ...
                        $this->panelContent_1 = HelperHTML::generateRecipeInfoCard($recipe, $creatorName, $userID, $this->pageID, $isFavourited, $avgReview, $totalReviews);
                    }
