...
include_once 'classlib/entities/RecipeTable.php';
include_once 'classlib/entities/IngredientTable.php';
include_once 'classlib/entities/RecipeStepTable.php';
include_once 'classlib/entities/RecipeIngredientTable.php';
include_once 'classlib/entities/DietTable.php';
include_once 'classlib/entities/RecipeDietsTable.php';
include_once 'classlib/entities/UserFavouritesTable.php';
include_once 'classlib/entities/RecipeReviewTable.php';
...
include_once 'models/panelContent/ViewUser.php';
include_once 'models/panelContent/ViewRecipe.php';
include_once 'models/panelContent/ManageRecipe.php';
include_once 'models/panelContent/GeneralRecipeDetails.php';
...
include_once 'models/panelContent/AdminRecipeDetails.php';

//Page models CUSTOMER
include_once 'models/panelContent/CustomerRecipeDetails.php';
...
if ($user->getLoggedInState()) {
    ...
    switch ($user->getUserType()) {
        ...
        case "Administrator":  //create new ADMIN controller
    ...
    echo '<section>';
        ...
        echo '<section style="background-color: #AAAAAA" >';
            ...
            foreach($_SESSION as $key=>$value){
                if (is_array($value)) {
                    echo '<tr><td>'.$key.'</td><td>'.htmlspecialchars(json_encode($value)).'</td></tr>';
                }
                else {
                    echo '<tr><td>'.$key.'</td><td>'.$value.'</td></tr>';      
                }
